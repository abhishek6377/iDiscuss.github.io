   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav me-auto mb-2 mb-lg-0">
       ...
       <li class="nav-item dropdown">
         ...
         $sql="SELECT * category_name,category_id,  FROM `idicuss` LIMIT 3";
         $result=mysqli_query($conn,$sql);
         while($row=mysqli_fetch_assoc($result)){
           echo'<li><a class="dropdown-item" href="threads.php?catid='.$row["category_id"]  . '">'.$row["category_name"].'</a>';
            // ask what is error video no 65.
          }
          echo'</li>
           </ul>
       </li>
     ...
     if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']== true){
       ...
       <p class="text-primary my-0 mx-2">Welcome to : '.$_SESSION['useremail'].'</p>
       <a href="partials/logout.php" class="btn btn-outline-success mx-2">
      Logout</a> </form>';
